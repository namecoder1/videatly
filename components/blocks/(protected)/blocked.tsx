...
const Blocked = ({ text } : { text: string }) => {
  return (
    <Card className='p-4 pl-6 dark:border-card border-input bg-white dark:bg-transparent rounded-[2rem] flex flex-col justify-start gap-y-2 sm:flex-row sm:items-center sm:justify-between'>
